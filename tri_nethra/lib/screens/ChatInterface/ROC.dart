...
import 'package:tri_nethra/screens/ChatInterface/CSARO.dart';
import 'package:tri_nethra/screens/login/localwidgets/orpop.dart';
import 'package:tri_nethra/services/location/locationScreen.dart';

class ROC extends StatefulWidget {
  final List<String> al;
  ROC({this.al});
  @override
  _ROCState createState() => _ROCState(al: al);
}

class _ROCState extends State<ROC> {
  List<String> al;
  String sel;
  _ROCState({this.al});
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  InkWell(
                      onTap: () {
                        setState(() {
                          sel = "Other Cyber Crime";
                          i1 = Icons.panorama_fish_eye;
                          i2 = Icons.check_circle;
                        });
                      },
                      child: but('Other Cyber Crime', i2)),
                  SizedBox(
